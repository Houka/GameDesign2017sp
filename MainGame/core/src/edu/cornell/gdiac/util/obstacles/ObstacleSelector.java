 ...
 */
package edu.cornell.gdiac.util.obstacles;
 ...
 * an obstacles through other obstacles.
 */
public class ObstacleSelector implements QueryCallback  {
	...
	/**
     * Returns the drawing scale for this obstacles selector
     *
    ...
    /**
     * Sets the drawing scale for this obstacles selector
     *
     * The drawing scale is the number of pixels to draw before Box2D unit. Because
     * mass is a function of area in Box2D, we typically want the physics objects
     * to be small.  So we decouple that scale from the physics object.  However,
