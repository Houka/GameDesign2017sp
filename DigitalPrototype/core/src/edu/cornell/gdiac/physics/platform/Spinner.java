...
public class Spinner extends ComplexObstacle {
	...
	/** The anchor pin for the spinner*/
	...
	public Spinner(float x, float y, float width, float height) {
		...
		pos.x -= width / 2;
		pin = new WheelObstacle(pos.x,pos.y,SPIN_PIN_RADIUS);
		pin.setName(SPIN_PIN_NAME+0);
	...
	protected boolean createJoints(World world) {
		...
		Vector2 anchor2 = new Vector2(-barrier.getWidth() / 2, 0);
