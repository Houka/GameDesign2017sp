...
public class RagdollModel extends ComplexObstacle {
	...
	protected boolean createJoints(World world) {
		...
		jointDef.localAnchorA.set(new Vector2(0, TORSO_OFFSET/2));
		jointDef.localAnchorB.set(new Vector2(0, -TORSO_OFFSET/2));
		...
		jointDef.localAnchorA.set(new Vector2(-ARM_XOFFSET/2, ARM_YOFFSET));
		jointDef.localAnchorB.set(new Vector2(ARM_XOFFSET/2, 0));
		jointDef.collideConnected = false;
		joint = world.createJoint(jointDef);
		joints.add(joint);

		// left forearm and left arm
		jointDef.bodyA = bodies.get(PART_LEFT_FOREARM).getBody();
		jointDef.bodyB = bodies.get(PART_LEFT_ARM).getBody();
		jointDef.localAnchorA.set(new Vector2(FOREARM_OFFSET/2, 0));
		jointDef.localAnchorB.set(new Vector2(-FOREARM_OFFSET/2, 0));
		jointDef.collideConnected = false;
		joint = world.createJoint(jointDef);
		joints.add(joint);
		...
		jointDef.bodyA = bodies.get(PART_RIGHT_FOREARM).getBody();
		jointDef.bodyB = bodies.get(PART_RIGHT_ARM).getBody();
		jointDef.localAnchorA.set(new Vector2(FOREARM_OFFSET/2, 0));
		jointDef.localAnchorB.set(new Vector2(-FOREARM_OFFSET/2, 0));
		jointDef.collideConnected = false;
		...
		jointDef.localAnchorA.set(new Vector2(-THIGH_XOFFSET, -THIGH_YOFFSET/2));
		jointDef.localAnchorB.set(new Vector2(0, THIGH_YOFFSET/2));
		jointDef.collideConnected = false;
		joint = world.createJoint(jointDef);
		joints.add(joint);

		// left shin and left thigh
		jointDef.bodyA = bodies.get(PART_LEFT_SHIN).getBody();
		jointDef.bodyB = bodies.get(PART_LEFT_THIGH).getBody();
		jointDef.localAnchorA.set(new Vector2(0, SHIN_OFFSET/2));
		jointDef.localAnchorB.set(new Vector2(0, -SHIN_OFFSET/2));
		jointDef.collideConnected = false;
		joint = world.createJoint(jointDef);
		joints.add(joint);

		// body and right thigh
		jointDef.bodyA = bodies.get(PART_BODY).getBody();
		...
		// right shin and rigth thigh
		jointDef.bodyA = bodies.get(PART_RIGHT_SHIN).getBody();
		jointDef.bodyB = bodies.get(PART_RIGHT_THIGH).getBody();
		jointDef.localAnchorA.set(new Vector2(0, SHIN_OFFSET/2));
		jointDef.localAnchorB.set(new Vector2(0, -SHIN_OFFSET/2));
		jointDef.collideConnected = false;
